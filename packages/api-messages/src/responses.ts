...
import { AuthorizationData, SocialAgentInvitation } from ".";
...
export type InvitationResponseMessage = IResponseMessage<
  ...
  S.Schema.Type<typeof SocialAgentInvitation>
>;
...
export class DescriptionsResponse {
  ...
  public payload: S.Schema.Type<typeof AuthorizationData>;
...
export class SocialAgentInvitationResponse {
  ...
  public payload: S.Schema.Type<typeof SocialAgentInvitation>;
